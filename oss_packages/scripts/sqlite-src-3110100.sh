...
PKG_CHECKSUM="52f96513281a97f0632d2280964798fa"

# name of directory after extracting the archive in working directory
PKG_DIR="sqlite-src-3110100"
...
{
    cd "${PKG_BUILD_DIR}"
    export CFLAGS="${M3_CFLAGS} ${SQLITE3_OMIT_FLAGS} -pthread -ldl"
    export LDFLAGS="${M3_LDFLAGS}"
    ./configure --target=${M3_TARGET} --host=${M3_TARGET} --prefix="" --disable-largefile --enable-tempstore --disable-readline --disable-tcl --disable-load-extension
}
