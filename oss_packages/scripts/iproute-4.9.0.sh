...
PKG_DOWNLOAD="https://www.kernel.org/pub/linux/utils/net/iproute2/iproute2-4.9.0.tar.gz"

# md5 checksum of archive in dl directory
PKG_CHECKSUM="b31b5cd1c164e2ea93878f06ea500963"
