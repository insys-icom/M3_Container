...
PKG_CHECKSUM="1999658298cf2fb837dffed8ff3c033ef0c98ef20cf73c5d5f66bed5ab89697c"
...
configure()
{
    # compile Python for amd64. This is only needed once in case there is not native python 3.12
    AR_TARGET="${AR}"
    NM_TARGET="${NM}"
    ...
    ln -s "${PYTHON_HOST}/bin/python3.12" "${PYTHON_HOST}/bin/python3"
