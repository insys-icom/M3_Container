...
DESCRIPTOR="A container to demonstrate a mosquitto mqtt broker"
CONTAINER_NAME="Mosquitto_MQTT_Broker"
ROOTFS_LIST="mosquitto_mqtt_broker.txt"

echo "This creates a container with a mosquitto mqtt broker in it"
echo ""
...
echo "- web_interface_mosquitto_mqtt_broker-0.1.sh"		
...
${OSS_PACKAGES_SCRIPTS}/web_interface_mosquitto_mqtt_broker-0.1.sh all
