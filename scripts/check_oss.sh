...
wget_check "Linux-PAM"  "https://github.com/linux-pam/linux-pam"                "Linux-PAM 1.5.3" ""
...
wget_check "sqlite-src" "https://www.sqlite.org/download.html"                  "sqlite-src-3420000.zip" ""
wget_check "cacert"     "https://curl.se/docs/caextract.html"                   "Tue May 30 03:12:04 2023 GMT" ""
...
wget_check "c-ares"     "https://github.com/c-ares/c-ares"                      "1.19.1</span>" ""
wget_check "libffi"     "https://github.com/libffi/libffi"                      "v3.4.4" ""
wget_check "xz"         "https://tukaani.org/xz"                                "5.4.3 was released on 2023-05-04." ""
wget_check "python"     "https://www.python.org/downloads"                      ">Download Python 3.11.4</a>" ""
wget_check "pyserial"   "https://pypi.org/project/pyserial/#files"              "pyserial-3.5.tar.gz" ""
wget_check "pymodbus"   "https://pypi.org/project/pymodbus/#files"              "pymodbus-3.4.0.tar.gz" ""
wget_check "nghttp2"    "https://github.com/nghttp2/nghttp2"                    "nghttp2 v1.55.1" ""
wget_check "libssh2"    "https://github.com/libssh2/libssh2"                    "libssh2-1.11.0" ""
wget_check "curl"       "https://curl.haxx.se/download.html"                    "<b>curl 8.2.0</b>, Released on" ""
wget_check "nano"       "https://www.nano-editor.org/download.php"              "nano-7.2.tar.xz" ""
wget_check "node"       "https://nodejs.org/en/download/current"                "<strong>20.5.0</strong>" ""
...
wget_check "stunnel"    "https://www.stunnel.org/downloads.html"                "stunnel-5.70.tar.gz" ""
wget_check "iptables"   "https://git.netfilter.org/iptables"                    "Age</th></tr>\n<tr><td><a href=\'/iptables/tag/\?h=v1.8.9\'>v1.8.9" ""
wget_check "libcap-ng"  "https://people.redhat.com/sgrubb/libcap-ng"            "Latest Release is 0.8.3" ""
wget_check "cJSON"      "https://github.com/DaveGamble/cJSON"                   "1.7.16</span>" ""
wget_check "mosquitto"  "https://mosquitto.org/download"                        "mosquitto-2.0.15.tar.gz" ""
wget_check "charset"    "https://pypi.org/project/charset-normalizer"           "charset-normalizer-3.2.0" ""
wget_check "idna"       "https://pypi.org/project/idna"                         "idna-3.4" ""
wget_check "requests"   "https://pypi.org/project/requests"                     "requests-2.31.0" ""
wget_check "urllib3"    "https://pypi.org/project/urllib3"                      "urllib3 2.0.4" ""
