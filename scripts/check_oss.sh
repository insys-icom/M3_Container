...
wget_check "timezone"   "https://www.iana.org/time-zones"                       "Released 2023-12-21" ""
...
wget_check "sqlite-src" "https://www.sqlite.org/download.html"                  "sqlite-src-3440200.zip" ""
...
wget_check "c-ares"     "https://github.com/c-ares/c-ares"                      "1.24.0</span>" ""
wget_check "libffi"     "https://github.com/libffi/libffi"                      "v3.4.4" ""
wget_check "xz"         "https://tukaani.org/xz"                                "5.4.5 was released on 2023-11-01." ""
...
wget_check "pymodbus"   "https://pypi.org/project/pymodbus/#files"              "pymodbus-3.6.2.tar.gz" ""
wget_check "nghttp2"    "https://github.com/nghttp2/nghttp2"                    "nghttp2 v1.58.0" ""
wget_check "libssh2"    "https://github.com/libssh2/libssh2"                    "libssh2-1.11.0" ""
wget_check "curl"       "https://curl.haxx.se/download.html"                    "<b>curl 8.5.0</b>, Released on" ""
...
wget_check "stunnel"    "https://www.stunnel.org/downloads.html"                "stunnel-5.71.tar.gz" ""
...
wget_check "urllib3"    "https://pypi.org/project/urllib3"                      "urllib3 2.1.0" ""
