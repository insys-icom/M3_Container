...
wget_check "openssl"    "https://www.openssl.org/source"                        "openssl-3.3.2.tar.gz" ""
...
wget_check "sqlite-src" "https://www.sqlite.org/download.html"                  "sqlite-src-3460100.zip" ""
...
wget_check "expat"      "https://github.com/libexpat/libexpat"                  '2.6.3</span>\n        <span title="Label: Latest"' ""
wget_check "c-ares"     "https://github.com/c-ares/c-ares"                      "1.33.1</span>" ""
...
wget_check "python"     "https://docs.python.org/3"                             "Python 3.12.6 documentation" ""
wget_check "pyserial"   "https://pypi.org/project/pyserial/#files"              "pyserial-3.5.tar.gz" ""
wget_check "pymodbus"   "https://pypi.org/project/pymodbus/#files"              "pymodbus-3.7.2.tar.gz" ""
wget_check "nghttp2"    "https://github.com/nghttp2/nghttp2"                    "nghttp2 v1.63.0" ""
wget_check "libssh2"    "https://github.com/libssh2/libssh2"                    "libssh2-1.11.0" ""
wget_check "curl"       "https://curl.haxx.se/download.html"                    "<b>curl 8.10.0</b>, Released on" ""
wget_check "nano"       "https://www.nano-editor.org/download.php"              "nano-8.2.tar.xz" ""
wget_check "node"       "https://nodejs.org/en/download/prebuilt-binaries"      "Download Node.js v20.17.0" ""
...
wget_check "httpd"      "https://httpd.apache.org"                              "Apache httpd 2.4.62 Released" ""
...
wget_check "openvpn"    "https://fossies.org/linux/openvpn/ChangeLog"           "openvpn-2.6.12/ChangeLog" ""
...
wget_check "stunnel"    "https://www.stunnel.org/downloads.html"                "stunnel-5.73.tar.gz" ""
