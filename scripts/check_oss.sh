...
wget_check "openssl"    "https://www.openssl.org/source"                        "openssl-3.6.2.tar.gz"
wget_check "pcre2"      "https://github.com/PhilipHazel/pcre2"                  ">PCRE2 10.47</span>"
wget_check "timezone"   "https://www.iana.org/time-zones"                       "Released 2026-03-01"
...
wget_check "dnsmasq"    "https://www.thekelleys.org.uk/dnsmasq"                 "LATEST_IS_2.92"
wget_check "sqlite-src" "https://www.sqlite.org/download.html"                  "sqlite-src-3530000.zip"
wget_check "cacert"     "https://curl.se/docs/caextract.html"                   "Wed Feb 11 18:26:30 2026 GMT"
wget_check "libuuid"    "http://sourceforge.net/projects/libuuid/files"         "libuuid-1.0.3.tar.gz \(318.3 kB\)"
wget_check "expat"      "https://github.com/libexpat/libexpat"                  '2.7.5</span>\n        <span title="Label: Latest"'
...
wget_check "python"     "https://docs.python.org/3"                             "Python 3.14.4 documentation"
...
wget_check "curl"       "https://curl.haxx.se/download.html"                    "<b>curl 8.19.0</b>, Released on"
...
wget_check "openvpn"    "https://github.com/OpenVPN/openvpn"                    ">v2.7.1</span>"
...
wget_check "requests"   "https://pypi.org/project/requests/"                    "requests 2.33.1</h1>"
wget_check "urllib3"    "https://pypi.org/project/urllib3/"                     "urllib3 2.6.3</h1>"
