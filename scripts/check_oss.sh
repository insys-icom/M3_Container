...
wget_check "openssl"    "https://www.openssl.org/source"                        "openssl-1.1.1s.tar.gz" ""
wget_check "pcre2"      "https://github.com/PhilipHazel/pcre2"                  ">pcre2-10.40</span>" ""
wget_check "timezone"   "https://www.iana.org/time-zones"                       "Released 2022-10-28" ""
...
wget_check "sqlite-src" "https://www.sqlite.org/download.html"                  "sqlite-src-3400000.zip" ""
...
wget_check "nghttp2"    "https://github.com/nghttp2/nghttp2"                    "nghttp2 v1.51.0" ""
wget_check "libssh2"    "https://github.com/libssh2/libssh2"                    "libssh2-1.10.0" ""
wget_check "curl"       "https://curl.haxx.se/download.html"                    "<b>curl 7.86.0</b>, Released on" ""
wget_check "nano"       "https://www.nano-editor.org/download.php"              "nano-7.0.tar.xz" ""
wget_check "node"       "https://nodejs.org/en/download"                        "Latest LTS Version: <strong>18.12.1</strong>" ""
