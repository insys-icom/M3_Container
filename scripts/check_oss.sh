...
wget_check "sqlite-src" "https://www.sqlite.org/download.html"                  "sqlite-src-3500100.zip"
wget_check "cacert"     "https://curl.se/docs/caextract.html"                   "Tue May 20 03:12:02 2025 GMT"
wget_check "libuuid"    "http://sourceforge.net/projects/libuuid/files"         "libuuid-1.0.3.tar.gz \(318.3 kB\)"
wget_check "expat"      "https://github.com/libexpat/libexpat"                  '2.7.1</span>\n        <span title="Label: Latest"'
wget_check "c-ares"     "https://github.com/c-ares/c-ares"                      "1.34.5</span>"
wget_check "libffi"     "https://github.com/libffi/libffi"                      "v3.5.0"
wget_check "xz"         "https://tukaani.org/xz"                                "5.8.1 \(2025-04-03\)"
wget_check "python"     "https://docs.python.org/3"                             "Python 3.13.4 documentation"
wget_check "pyserial"   "https://pypi.org/project/pyserial/#files"              "pyserial-3.5.tar.gz"
wget_check "pymodbus"   "https://github.com/pymodbus-dev/pymodbus"              "Pymodbus v3.9.2</span>"
wget_check "nghttp2"    "https://github.com/nghttp2/nghttp2"                    "nghttp2 v1.65.0"
wget_check "libssh2"    "https://github.com/libssh2/libssh2"                    "libssh2-1.11.1"
wget_check "curl"       "https://curl.haxx.se/download.html"                    "<b>curl 8.14.1</b>, Released on"
wget_check "nano"       "https://www.nano-editor.org/download.php"              "nano-8.4.tar.xz"
...
wget_check "nmap"       "https://nmap.org/dist"                                 "The latest Nmap release is version 7.97"
wget_check "openvpn"    "https://fossies.org/linux/openvpn/ChangeLog"           "openvpn-2.6.14/ChangeLog"
...
wget_check "stunnel"    "https://www.stunnel.org/downloads.html"                "stunnel-5.75.tar.gz"
...
wget_check "mosquitto"  "https://mosquitto.org/download"                        "mosquitto-2.0.21.tar.gz"
wget_check "charset"    "https://github.com/jawah/charset_normalizer"           "Version 3.4.2"
wget_check "idna"       "https://github.com/kjd/idna"                           ">v3.10</span>"
wget_check "requests"   "https://github.com/psf/requests"                       "v2.32.4"
wget_check "urllib3"    "https://github.com/urllib3/urllib3"                    "2.4.0</span>"
