...
wget_check "openssl"    "https://www.openssl.org/source"                        "openssl-3.1.0.tar.gz" ""
...
wget_check "pymodbus"   "https://pypi.org/project/pymodbus/#files"              "pymodbus-3.2.2.tar.gz" ""
wget_check "nghttp2"    "https://github.com/nghttp2/nghttp2"                    "nghttp2 v1.53.0" ""
wget_check "libssh2"    "https://github.com/libssh2/libssh2"                    "libssh2-1.10.0" ""
wget_check "curl"       "https://curl.haxx.se/download.html"                    "<b>curl 8.1.1</b>, Released on" ""
...
wget_check "openvpn"    "https://fossies.org/linux/openvpn/ChangeLog"           "openvpn-2.6.4/ChangeLog" ""
...
wget_check "stunnel"    "https://www.stunnel.org/downloads.html"                "stunnel-5.69.tar.gz" ""
