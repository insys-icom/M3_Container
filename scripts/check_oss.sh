...
wget_check "dropbear"   "https://matt.ucc.asn.au/dropbear/dropbear.html"        "Latest is 2026.93"
wget_check "dnsmasq"    "https://www.thekelleys.org.uk/dnsmasq"                 "LATEST_IS_2.93"
wget_check "sqlite-src" "https://www.sqlite.org/download.html"                  "sqlite-src-3530300.zip"
wget_check "cacert"     "https://curl.se/docs/caextract.html"                   "Thu Jul 16 03:12:01 2026 GMT"
wget_check "libuuid"    "http://sourceforge.net/projects/libuuid/files"         "libuuid-1.0.3.tar.gz \(318.3 kB\)"
wget_check "expat"      "https://github.com/libexpat/libexpat"                  "2.8.2</span"
wget_check "c-ares"     "https://github.com/c-ares/c-ares"                      "1.34.8</span>"
wget_check "libffi"     "https://github.com/libffi/libffi"                      "v3.5.0"
wget_check "xz"         "https://tukaani.org/xz"                                "5.8.3 \(2026-03-31\)"
wget_check "python"     "https://docs.python.org/3"                             "Python 3.14.6 documentation"
wget_check "pyserial"   "https://github.com/pyserial/pyserial"                  ">v3.5</span>"
wget_check "pymodbus"   "https://github.com/pymodbus-dev/pymodbus"              "Pymodbus v3.14.0</span>"
wget_check "paho-mqtt"  "https://github.com/eclipse-paho/paho.mqtt.python"      "v2.1.0</span>"
...
wget_check "nano"       "https://www.nano-editor.org/download.php"              "nano-9.1.tar.xz"
...
wget_check "jansson"    "https://github.com/akheron/jansson"                    "v2.15.1</span>"
...
wget_check "openvpn"    "https://github.com/OpenVPN/openvpn"                    ">v2.7.5</span>"
...
wget_check "stunnel"    "https://www.stunnel.org/downloads.html"                "stunnel-5.79.tar.gz"
...
wget_check "charset"    "https://github.com/jawah/charset_normalizer"           "Version 3.4.9"
...
wget_check "libevent"   "https://github.com/libevent/libevent"                  "release-2.1.13-stable"
